	...
	<BODY>
		<CENTER>
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_MSColumn3D.swf","myChartid","600","500");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_MSBar2D.swf","myChartid","600","500");
				  myChart.setDataXML("<%=strXML%>");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_MSColumn2D.swf","myChartid","1200","500");
				 myChart.setDataXML("<%=strXML%>");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_MSLine.swf","myChartid","1200","500");
				  myChart.setDataXML("<%=strXML%>");
