...
<HTML>
	...
	<BODY>
		...
		Column3D
		<%
		 	String chartHTMLCode=createChartHTML(imgpath+"/widgets/fusionCharts/swfs/v2/FCF_Column3D.swf", strXML, "", "myFirst", 600, 300, false) ;
		...
		%>
		   <%=chartHTMLCode%>
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_Pie3D.swf","myChartid","400","400");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_Line.swf","myChartid","600","500");
				  myChart.setDataXML("<%=strXML%>");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_Column3D.swf","myChartid","600","500");
				  myChart.setDataXML("<%=strXML%>");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_Column2D.swf","myChartid","600","500");
				  myChart.setDataXML("<%=strXML%>");
			...
			<script type="text/javascript">
				  var myChart = new FusionCharts("<%=imgpath%>/widgets/fusionCharts/swfs/v2/FCF_Area2D.swf","myChartid","600","500");
				  myChart.setDataXML("<%=strXML%>");
